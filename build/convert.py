...
TEXT = [
 ...
 ("Honeycutt", ""),
 ("within a two-hour radius of Dalton", "across DFW, North Texas, Dallas, Waco, Austin and the Cedar Creek Lake area"),
 ("Free in-home consultations within 2 hours of Dalton",
  "Free in-home consultations across Texas"),
...
PRODUCT_COPY = {
 ...
 "plantation-shutters": ("Plantation Shutters in Texas | Custom Built & Installed", "Louvered plantation shutters custom built to each opening and professionally installed across DFW, North Texas, Dallas, Waco and Austin.", ["Wood Plantation Shutters","Composite Plantation Shutters"]),
...
CORE = {
 "index.html": ("/", "Custom Blinds, Shades & Shutters in Texas | Love Is Blinds",
   "Custom blinds, shades and plantation shutters across DFW, North Texas, Dallas, Waco and Austin. Free in-home consultation. Call (866) 518-2999."),
 "about.html": ("/about", "About Love Is Blinds Texas | Custom Window Treatments",
   "Three local franchises covering DFW, North Texas, Dallas, Waco, Austin and Cedar Creek Lake. We measure, order and install every job ourselves."),
 ...
 "team.html": ("/meet-the-team", "Meet the Team | Love Is Blinds Texas",
   "The people who measure and install your window treatments across DFW, North Texas, Dast Texas and Central Texas."),
